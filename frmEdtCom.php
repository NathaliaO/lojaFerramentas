...
<html>
    <head>
        <meta charset="UTF-8">
        <title> Editar Item_Compra </title>
    ...
    <div id="fullscreen_bg" class="fullscreen_bg">
      <div class="container col-md-8">
        <h1 class="text-white col-md-8">Editar Item_compra</h1>
           <form id="frmEdtPro" name="frmEdtPro" method="POST" action="edtCom.php">
           <div id="borda" class="col-md-8">
             ...
             <div class="form-group">
                 <label for="lblIdPed">ID Pedido: <?php echo $linha['idped']?></label>
                 <input type="hidden" id="idped" name="idped" value="<?php echo $linha['pedido']?>">
             </div>
             <div class="form-group">
                 <label for="lblProd">Produto: </label>
                 <input type="text" id="txtProd" name="txtProd" class="form-control col-md-6 border border-dark" value="<?php echo $linha['produto']?>">
             </div>
             <div class="form-group">
