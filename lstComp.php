<?php
    ...
    $rs = mysql_query("SELECT * FROM item_pedido;"); //rs = conjunto de registro
?>

<html>
    <head>
        <meta charset="UTF-8">
        <title> Lista de Item_Pedido </title>
    ...
    <body>
        ...
        <h1 class="text-white col-md-8" id="inic">Lista de Item_Pedido</h1>
        ...
        <table class="table table table-hover table-dark col-md-8" id="tbBorda">
            ...
            <?php while ($linha = mysql_fetch_array($rs)) {?>
                <tr>
                    ...
                    <td>
                        <button id="btEdit" class="btn btn-outline-warning" onclick="javascript:location.href='frmEdtComp.php?id=' + 
