<?php
    ...
    $rs = mysql_query("SELECT * FROM produto;"); //rs = conjunto de registro
?>
...
<html>
    ...
    <body>
        ...
        <button id="btAdc" name="btAdc" class="btn btn-secondary btn-lg btn float-right" onclick="javascript:location.href='frmInsProd.html'" value='Adicionar'"> <i class="far fa-plus-square"></i> Adicionar</button>
        <br>
        <br>
        <table class="table table table-hover table-dark col-md-8" id="tbBorda">
            ...
            <?php while ($linha = mysql_fetch_array($rs)) {?>
                <tr>
                    ...
                    <td>
                        <button id="btEdit" class="btn btn-outline-warning" onclick="javascript:location.href='frmEdtProd.php?id=' + 
                        <?php echo $linha['id'] ?>" value='Editar'" > <i class="far fa-edit"></i></button>
                    </td>
                    <td>
                        <button id="btRem" class="btn btn-outline-danger" onclick="javascript:location.href='frmRemProd.php?id=' + 
